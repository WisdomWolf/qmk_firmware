...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  _______, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   ADJUST, KC_DOWN,    KC_UP, _______  \
),
...
[_ADJUST] =  LAYOUT_ortho_4x12( \
  ...
  _______, _______,   KC_UP,    AU_ON,   AU_OFF,  _______, _______, _______, _______, _______, _______,  KC_DEL, \
